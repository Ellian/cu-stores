...
var ControlGameStore = Reflux.createStore({
    handles: cu_events_1["default"].handlesControlGame,
    listenables: cu_events_1["default"].handlesControlGame.action,
    start: function () {
        ...
        cu_events_1["default"].on(this.handles.name, function (controlGame) {
            // Update store info
